        ...
        <div class="container d-flex flex-column">
            <div class="row align-items-center justify-content-between vh-100">
                <div class="col-12 text-center">
                    ...
                    <h6 class="display-1 mb-3 mt-5 fw-bolder text-danger"><?php ee('Error') ?> <strong class="text-primary">404</strong></h6>
                    ...
                    <a href="<?php echo route('home') ?>" class="btn btn-primary px-5 py-3">
                        <i class="fa fa-chevron-left me-3"></i> <?php ee('Back to home') ?>
                    </a>
                    <a href="<?php echo route('contact') ?>" class="fw-bold btn px-5 py-3">
                        <?php ee('Contact Us') ?>
                    </a>
                </div>
            </div>
